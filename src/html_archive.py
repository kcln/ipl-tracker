...
<body>
  ...
  <div class="wrap">
    ...
    <nav class="bar">
      <a class="mark" href="https://github.com/kcln" target="_blank" rel="noopener" aria-label="KC Lakshminarasimham">
        <img src="assets/lion-transparent.png" alt="Simham lion mark" width="44" height="44">
      </a>
